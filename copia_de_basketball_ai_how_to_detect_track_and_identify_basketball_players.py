# -*- coding: utf-8 -*-
"""Copia de basketball-ai-how-to-detect-track-and-identify-basketball-players.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wwYWs-ILerFGJBrQw8SJtFU6Ma30w0QO
...
# Esto mostrará la ubicación del archivo y el código fuente de la clase
print(f"Archivo: {inspect.getfile(TeamClassifier)}\n")
print(inspect.getsource(TeamClassifier))
